...
exports.test = (describe, it, assert, helpLib) => {
	...
	describe('Test common library', () => {
		...
		it('checking isInstance function', () => {
			...
			assert.isFalse(helpLib.isInstance(true, {}),
				'result with "(bool) true, (object) {}" parameters is incorrect');
			assert.isFalse(helpLib.isInstance(true, Boolean),
				'result with "(bool) true, (object) Boolean" parameters is incorrect');
			assert.isFalse(helpLib.isInstance(true, 'boolean'),
				'result with "(bool) true, (string) \'boolean\'" parameters is incorrect');
			...
			assert.isFalse(helpLib.isInstance('', {}),
				'result with "(object) \'\', (object) {}" parameters is incorrect');
			assert.isFalse(helpLib.isInstance('', String),
				'result with "(object) \'\', (object) String" parameters is incorrect');
			assert.isFalse(helpLib.isInstance('', 'string'),
				'result with "(object) \'\', (string) \'string\'" parameters is incorrect');
			...
			assert.isFalse(helpLib.isInstance(Infinity, {}),
				'result with "Infinity, (object) {}" parameters is incorrect');
			assert.isFalse(helpLib.isInstance(Infinity, Infinity),
				'result with "Infinity, Infinity" parameters is incorrect');
			assert.isFalse(helpLib.isInstance(Infinity, Number),
				'result with "Infinity, (object) Number" parameters is incorrect');
			assert.isFalse(helpLib.isInstance(Infinity, 'number'),
				'result with "Infinity, (string) \'number\'" parameters is incorrect');
